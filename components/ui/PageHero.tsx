  ...
  return (
    <section className={`relative min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-600 text-white px-4 overflow-hidden ${className}`}>
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 hero-title">{title}</h1>
        {subtitle && (
          <p className="text-lg md:text-xl lg:text-2xl text-emerald-100 max-w-2xl mx-auto hero-subtitle">{subtitle}</p>
        )}
      </div>
      {/* Scroll indicator */}
